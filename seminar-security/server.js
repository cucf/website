...
routes.post = function(request,response) {
	...
	var sanitizeHtml = require('sanitize-html'); /// WE ADDED THIS!!!
	...
	request.on('end',function() {
		...
		var cleanContent = sanitizeHtml(POST.content); /// WE ADDED THIS!!!

		collection.insertOne({ post : cleanContent }); /// WE CHANGED THIS!!!
